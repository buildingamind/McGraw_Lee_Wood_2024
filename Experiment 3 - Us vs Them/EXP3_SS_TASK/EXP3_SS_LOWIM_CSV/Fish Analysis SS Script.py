...
with warnings.catch_warnings():
    ...
    for model in models:
        # Load data
        DATA_PATH = "G:/McGraw 2024 Source/Experiment 3 - Us vs Them in Two Colored Fishes/EXP3_SS_TASK/EXP3_SS_LOWIM_CSV/"
        source_csv = fr"LOWIM_SS_{model}.csv"
        ...
        output_df.to_csv(rf"{DATA_PATH}/LOWIM_FISH_{model}_Self_Segregation_by_Episode.csv")
        ###############################################################################
        ...
        plt.savefig(f'{DATA_PATH}/LOWIM_{model}_SS.png')
        plt.close()
        ...
        plt.savefig(f'{DATA_PATH}/LOWIM_{model}_SS_WITHIN.png')
        plt.close()
        ...
        individual_data_df.to_csv(rf"{DATA_PATH}/LOWIM_FISH_{model}_Self_Segregation_Individual_Data.csv", index=False)
